...
type FlowState =
  ...
  | "audio-playing" // Lecture audio (avant 30 secondes)
  | "feedback-active"; // Formulaire de feedback actif (après 30 secondes)
...
export default function Home() {
  ...
  const handleThresholdReached = () => {
    // Affichage du formulaire de feedback après 30 secondes d'écoute
      ...
      <div className="w-full max-w-2xl">
        <header className="mb-8 text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Découvrez une nouvelle façon de réviser vos cours à l'approche des
            devoirs : testez et donnez-nous vos retours
          </p>
        </header>
        <Card className="w-full overflow-hidden shadow-2xl ring-1 ring-black/5">
          <CardContent className="p-6 sm:p-8">
            <AnimatePresence mode="wait">
              ...
              {(flowState === "audio-playing" ||
                flowState === "feedback-active") &&
                currentCourse &&
                userInfo && (
                  <motion.div
                    key="audio-feedback"
                    ...
                    <AudioLayout
                      audioPlayer={
                        <AudioPlayer
                          ...
                          onThresholdReachedAction={handleThresholdReached}
        ...
        <footer className="mt-8 text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} AudioPoll. Tous droits réservés.
          </p>
        </footer>
      </div>
    </main>
